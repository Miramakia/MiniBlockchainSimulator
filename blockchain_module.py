...
class Block:
    def __init__(self, transactions, previous_hash="0", block_version="1", difficulty=2): 
        #خصائص البلوك
...
# الميثود الخاصة باثبات العمل (يتم حساب الهاش مع ايجاد رقم ال...nonce )
    def proof_of_work(self):
        print(f"\nCalculating Proof of Work for block with Merkle Root: {self.merkle_root}")
        block_hash = ""
...
# ميثود لانشاء اول بلوك 
    def create_genesis_block(self):
        ...
        genesis_block = Block(transactions=genesis_tx, previous_hash="0")
...
# ميثود لاضافة بلوك جديد للسلسلة 
    def add_block(self, transactions):
        ...
        new_block = Block(signed_transactions, previous_hash=prev_hash)
...
while True:
    ...
    block_number += 1 # من اجل وضع رقم ترتيب البلوك عند اضافته 
>>>>>>> 563dd22ff2a855283757ff13604e846cacdc8bc0
